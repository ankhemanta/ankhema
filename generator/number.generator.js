...
export const generatRandomUserId = (size) => {
  let num = 0;
...
export const generatRandomId = (size) => {
  let num = 0;
  var numStr = num.toString();
  while (numStr.length < size) {
    numStr = 0 + numStr;
...
export function generatRandomText(string_length) {
  var random_string = '';
...
export function genRandomKey(string_length) {
  var random_string = '';
